...
<head>
    ...
    <title>Admin</title>
    <link type="image/png" sizes="32x32" rel="icon" href="https://img.icons8.com/retro/32/basketball.png">
    ...
    <nav class="navbar navbar-dark bg-dark navbar-expand-lg">
        <div class="container-fluid">
            ...
            <form class="d-flex order-lg-1">
                ...
                <div class="dropdown">
                    <a class="btn dropdown text-white" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
