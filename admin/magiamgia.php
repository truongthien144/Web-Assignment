...
<div class="container" style="height: 100%;">
    <div class="div-text">
        <h1 class="text-center text-capitalize my-4">Thông tin code giảm giá</h1>
        <div class="div-btn-mgg d-flex justify-content-center mb-4">
            <button class="btn btn-primary rounded-2 px-3 btn-mgg btn-mgg-insert">Thêm</button>
        </div>
    </div>

    <table class="table tbale_mgg table-striped table-bordered">
        <tr class="text">
            <th class="text-center">Cohe</th>
