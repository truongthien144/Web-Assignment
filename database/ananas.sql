...
CREATE TABLE IF NOT EXISTS `product` (
  `product_id` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENTT 'ID of the product',
  `productName` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'Name of the product',
  `Category_id` TINYINT NOT NULL COMMENT 'Category ID',
  `Subcategory_id` TINYINT NOT NULL COMMENT 'Subcategory ID',
...
VALUES 
    ...
    ('AV00202','Urbas SC - Mule','FO','URB',330000,620000,290000,'Dusty Blue',137,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas NE<br>Outsole: Rubber',),
    ...
    ('AV00158','Pattas Polka Dots - High Top','FO','PAT',460000,750000,290000,'Offwhite',330,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas NE<br>Outsole: Rubber',),
    ...
    ('AV00172','Pattas Polka Dots - High Top','FO','PAT',460000,750000,290000,'Jelly Bean',509,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas NE<br>Outsole: Rubber',),
    ...
    ('AV00183','Urbas SC - Low Top','FO','URB',290000,580000,290000,'Dark Purple',214,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas NE<br>Outsole: Rubber',),
    ...
    ('AV00206','Vintas Vivu - Low Top','FO','VIN',186000,620000,434000,'Plantation',321,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas NE<br>Outsole: Rubber',),
    ...
    ('AV00189','Urbas SC - Low Top','FO','URB',330000,620000,290000,'Aloe Wash',72,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas NE<br>Outsole: Rubber',),
    ('AV00149','Basas Workaday - Low Top','FO','BAS',116000,580000,464000,'Black',239,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas NE<br>Outsole: Rubber<br>Có thêm 01 bộ dây đi kèm',),
    ...
    ('AV00180','Pattas Tomo - Low Top','FO','PAT',216000,720000,504000,'Blarney',273,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas NE<br>Outsole: Rubber',),
    ('AV00181','Pattas Tomo - Mule','FO','PAT',360000,720000,360000,'Primrose Yellow',138,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas NE<br>Outsole: Rubber',),
    ('AV00199','Urbas SC - Mule','FO','URB',290000,580000,290000,'Fair Orchid',148,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas NE<br>Outsole: Rubber',),
    ...
    ('A6T016','Track 6 Jazico - Low Top','FO','TRA',119000,1190000,1071000,'Royal White',237,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas NE<br>Outsole: Rubber',),
    ...
    ('AV00165','Urbas Corluray Mix - Low Top','FO','URB',244000,610000,366000,'Corluray Mix',0,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Corduroy<br>Outsole: Rubber',),
    ...
    ('AV00201','Urbas SC - Mule','FO','URB',290000,580000,290000,'Foliage',285,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas NE<br>Outsole: Rubber',),
    ...
    ('AV00144','Basas Evergreen - Mule','FO','BAS',232000,580000,348000,'Evergreen',341,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas NE<br>Outsole: Rubber<br>Có thêm 01 bộ dây đi kèm',),
    ('AV00207','Vintas Public 2000s - Low Top','FO','VIN',186000,620000,434000,'Insignia Blue',323,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas NE<br>Outsole: Rubber',),
    ('AV00173','Vintas Jazico - Low Top','FO','VIN',144000,720000,576000,'Royal White',216,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas/Leather<br>Outsole: Rubber',),
    ...
    ('AV00174','Vintas Jazico - High Top','FO','VIN',156000,780000,624000,'Royal White',213,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas/Leather<br>Outsole: Rubber',),
    ('AV00171','Pattas Polka Dots - Low Top','FO','PAT',430000,720000,290000,'True Blue',501,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas NE<br>Outsole: Rubber',),
    ...
    ('ALP2401','Urbas Love+ 24','FO','URB',0,650000,650000,'Oyster White',46,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Suede / Canvas<br>Outsole: Rubber',),
    ('AV00208','Vintas Public 2000s - Low Top','FO','VIN',124000,620000,496000,'Brindle',271,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas NE<br>Outsole: Rubber',),
    ...
    ('AHCS007','High Crew Socks - Ananas Daily Things','AC','SOC',0,95000,95000,'Sunny Lime',28,'Giới tính – /Unisex/<br>Họa tiết – /Ananas Daily Things/<br>Thành phần – /53% Cotton, 40% Polyester, 3% Spandex, 2% Nylon, 2% Elastan/',),
    ('AHCS012','High Crew Socks - Ananas Daily Things','AC','SOC',0,95000,95000,'Laurel Oak',0,'Giới tính – /Unisex/<br>Họa tiết – /Ananas Daily Things/<br>Thành phần – /53% Cotton, 40% Polyester, 3% Spandex, 2% Nylon, 2% Elastan/',),
    ...
    ('AHCS011','High Crew Socks - Ananas Daily Things','AC','SOC',0,95000,95000,'Candy Pink',17,'Giới tính – /Unisex/<br>Họa tiết – /Ananas Daily Things/<br>Thành phần – /53% Cotton, 40% Polyester, 3% Spandex, 2% Nylon, 2% Elastan/',),
    ('AHCS010','High Crew Socks - Ananas Daily Things','AC','SOC',0,95000,95000,'Cinnamon Stick',0,'Giới tính – /Unisex/<br>Họa tiết – /Ananas Daily Things/<br>Thành phần – /53% Cotton, 40% Polyester, 3% Spandex, 2% Nylon, 2% Elastan/',),
    ...
    ('AHP003','Hip Pack - Ananas Global Goal','AC','HIP',55000,275000,220000,'Blue Berry',13,'Giới tính: Unisex<br>Chất liệu: Taslan, định lượng 230gsm (trượt nước)<br>Thành phần chất liệu: 100% Polyester<br>Kích thước: 280 x 120 x 100 mm (W x H x D)<br>Dung tích: 2.0 lit<br>Hoạ tiết: Ananas Global Goal',),
    ...
    ('AHP001','Hip Pack - Ananas Global Goal','AC','HIP',55000,275000,220000,'Climbing Ivy',21,'Giới tính: Unisex<br>Chất liệu: Taslan, định lượng 230gsm (trượt nước)<br>Thành phần chất liệu: 100% Polyester<br>Kích thước: 280 x 120 x 100 mm (W x H x D)<br>Dung tích: 2.0 lit<br>Hoạ tiết: Ananas Global Goal',),
    ...
    ('AHCS004','High Crew Socks - Ananas Puppet Club','AC','SOC',0,119000,119000,'Tie Dye',25,'Gender – /Unisex/<br><br>Họa tiết – /Ananas Puppet Club/<br><br>Kỹ thuật – /Nhuộm Tie Dye/<br><br>Thành phần – /78% Cotton, 15% Spandex, 5% Rubber, 2% Nylon/',),
    ('AGT0023','Graphic Tee - Dance Till Sunrise','TO','GRA',0,350000,350000,'Jet Black',13,'Giới tính: Unisex<br>Form dáng: Regular<br>Chất liệu: Single Jersey, định lượng 220GSM<br>Thành phần chất liệu: 100% Cotton<br>Size: S – M – L – XL<br>Hoạ tiết: Dance Till Sunrise<br>Sử dụng phương pháp in PET.',),
    ...
    ('AGLT0028','Long Sleeve Graphic Tee - Love, Peace & Music','TO','GRA',0,390000,390000,'Jet Black',24,'Giới tính: Unisex<br>Form dáng: Regular<br>Chất liệu: Single Jersey, định lượng 220GSM<br>Thành phần chất liệu: 100% Cotton<br>Size: S – M – L – XL<br>Hoạ tiết: Love, Peace & Music<br>Sử dụng phương pháp in lụa.',),
    ...
    ('AET00002','Pigment Tee - Nice Nature Club','TO','EFF',0,390000,390000,'Greener Pastures',46,'Giới tính: Unisex<br>Form dáng: Regular<br>Chất liệu: Single Jersey, định lượng 210GSM<br>Thành phần chất liệu: 100% Cotton<br>Size: S – M – L – XL<br>Hoạ tiết: Nice Nature Club<br>Kỹ thuật nhuộm Pigment Dye.',),
    ...
    ('AET00001','Pigment Tee - AAA New Standard','TO','EFF',0,390000,390000,'Kangaroo',52,'Giới tính: Unisex<br>Form dáng: Regular<br>Chất liệu: Single Jersey, định lượng 250GSM<br>Thành phần chất liệu: 100% Cotton<br>Size: S – M – L – XL<br>Hoạ tiết: AAA – New Standard<br>Kỹ thuật nhuộm Pigment Dye.',),
    ...
    ('AGT0024','Graphic Tee - The Guitar Sings','TO','GRA',0,350000,350000,'Jet Black',10,'Giới tính: Unisex<br>Form dáng: Regular<br>Chất liệu: Single Jersey, định lượng 220GSM<br>Thành phần chất liệu: 100% Cotton<br>Size: S – M – L – XL<br>Hoạ tiết: The Guitar Sings<br>Sử dụng phương pháp in lụa.',),
    ...
    ('AGT0022','Graphic Tee - Logos Packed','TO','GRA',0,350000,350000,'Snow White',3,'Giới tính: Unisex<br>Form dáng: Regular<br>Chất liệu: Single Jersey, định lượng 220GSM<br>Thành phần chất liệu: 100% Cotton<br>Size: S – M – L – XL<br>Hoạ tiết: Logos Packed<br>Sử dụng phương pháp in PET.',),
    ...
    ('AGT0021','Graphic Tee - Skate 4P','TO','GRA',0,350000,350000,'Snow White',4,'Giới tính: Unisex<br>Form dáng: Regular<br>Chất liệu: Single Jersey, định lượng 220GSM<br>Thành phần chất liệu: 100% Cotton<br>Size: S – M – L – XL<br>Hoạ tiết: Skate 4P<br>Sử dụng phương pháp in PET.',),
    ...
    ('AGLT0027','Long Sleeve Graphic Tee - Love, Peace & Music','TO','GRA',0,390000,390000,'White',20,'Giới tính: Unisex<br>Form dáng: Regular<br>Chất liệu: Single Jersey, định lượng 220GSM<br>Thành phần chất liệu: 100% Cotton<br>Size: S – M – L – XL<br>Hoạ tiết: Love, Peace & Music<br>Sử dụng phương pháp in lụa.',),
    ('AGT0026','Graphic Tee - Logos Packed','TO','GRA',0,350000,350000,'Vibrant Orange',16,'Giới tính: Unisex<br>Form dáng: Regular<br>Chất liệu: Single Jersey, định lượng 220GSM<br>Thành phần chất liệu: 100% Cotton<br>Size: S – M – L – XL<br>Hoạ tiết: Logos Packed<br>Sử dụng phương pháp in lụa.',),
    ('AV00210','Basas Day Slide - Slip On','FO','BAS',0,550000,550000,'Offwhite',317,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas<br>Outsole: Rubber',),
    ('AV00211','Basas Day Slide - Slip On','FO','BAS',0,550000,550000,'Caviar Black',324,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas<br>Outsole: Rubber',),
    ('AV00144','Basas Evergreen - Mule','FO','BAS',232000,580000,348000,'Evergreen',341,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas NE<br>Outsole: Rubber<br>Có thêm 01 bộ dây đi kèm',),
    ('AV00167','Urbas Corluray Mix - High Top','FO','URB',260000,650000,390000,'Corluray Mix',99,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Corduroy<br>Outsole: Rubber',),
    ('A6T014','Track 6 2.Blues - Low Top','FO','TRA',238000,1190000,952000,'Navy Blue',105,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Eco Nylon Fabric<br>Outsole: Rubber',),
    ('ALP2023','Urbas Love+ 23 - Slip On','FO','URB',0,550000,550000,'Offwhite',0,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Canvas<br>Outsole: Rubber',),
    ('AV00154','Vintas Soda Pop - Low Top','FO','VIN',390000,680000,290000,'Amparo Blue',208,'Gender: Unisex<br>Size run: 35 – 46<br>Upper: Corduroy<br>Outsole: Rubber',);
...
CREATE TABLE IF NOT EXISTS `product_sizes` (
  `product_id` VARCHAR(20) NOT NULL,    -- Product ID (e.g., 'AV00121')
  `sizes` TEXT NOT NULL,                -- Sizes (e.g., '[35, 36, 37, 38, 39, 40, 41, 42]')
  PRIMARY KEY (`product_id`)            -- Primary key is the product_id
...
--
ALTER TABLE `product`
  ADD CONSTRAINT `FK_pro_id` FOREIGN KEY (`category_id`) REFERENCES `category` (`category_id`),
  ADD CONSTRAINT `FK_pro_id` FOREIGN KEY (`subcategory_id`) REFERENCES `subcategory` (`subcategory_id`);
